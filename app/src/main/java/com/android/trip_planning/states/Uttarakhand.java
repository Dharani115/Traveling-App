...
public class Uttarakhand extends AppCompatActivity {
    ...
    private static  final String BASE_URL = "http://192.168.43.42/travel/state25.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manager = new GridLayoutManager(Uttarakhand.this, 1);
    ...
    private void getProducts (){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, BASE_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Uttarakhand.this,"error",Toast.LENGTH_LONG).show();

                        }

                        mAdapter = new RecyclerAdapter(Uttarakhand.this,products);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                progressBar.setVisibility(View.GONE);
                Toast.makeText(Uttarakhand.this, error.toString(),Toast.LENGTH_LONG).show();

            }
        });

        Volley.newRequestQueue(Uttarakhand.this).add(stringRequest);
