...
public class Kerala extends AppCompatActivity {
    ...
    private static  final String BASE_URL = "http://192.168.43.42/travel/state11.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manager = new GridLayoutManager(Kerala.this, 1);
    ...
    private void getProducts (){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, BASE_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Kerala.this,"error",Toast.LENGTH_LONG).show();

                        }

                        mAdapter = new RecyclerAdapter(Kerala.this,products);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                progressBar.setVisibility(View.GONE);
                Toast.makeText(Kerala.this, error.toString(),Toast.LENGTH_LONG).show();

            }
        });
        Volley.newRequestQueue(Kerala.this).add(stringRequest);
