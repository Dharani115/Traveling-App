...
public class UttarPradesh extends AppCompatActivity {
    ...
    private static  final String BASE_URL = "http://192.168.43.42/travel/state26.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manager = new GridLayoutManager(UttarPradesh.this, 1);
    ...
    private void getProducts (){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, BASE_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(UttarPradesh.this,"error",Toast.LENGTH_LONG).show();

                        }

                        mAdapter = new RecyclerAdapter(UttarPradesh.this,products);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                progressBar.setVisibility(View.GONE);
                Toast.makeText(UttarPradesh.this, error.toString(),Toast.LENGTH_LONG).show();

            }
        });

        Volley.newRequestQueue(UttarPradesh.this).add(stringRequest);
