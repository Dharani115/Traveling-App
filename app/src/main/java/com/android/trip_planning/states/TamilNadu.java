...
public class TamilNadu extends AppCompatActivity {
    ...
    private static  final String BASE_URL = "http://192.168.43.42/travel/state22.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manager = new GridLayoutManager(TamilNadu.this, 1);
    ...
    private void getProducts (){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, BASE_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(TamilNadu.this,"error",Toast.LENGTH_LONG).show();

                        }

                        mAdapter = new RecyclerAdapter(TamilNadu.this,products);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                progressBar.setVisibility(View.GONE);
                Toast.makeText(TamilNadu.this, error.toString(),Toast.LENGTH_LONG).show();

            }
        });
        Volley.newRequestQueue(TamilNadu.this).add(stringRequest);
    }
