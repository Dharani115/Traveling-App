...
public class Goa extends AppCompatActivity {
    ...
    private static  final String BASE_URL = "http://192.168.43.42/travel/state6.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manager = new GridLayoutManager(Goa.this, 1);
    ...
    private void getProducts (){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, BASE_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Goa.this,"error",Toast.LENGTH_LONG).show();

                        }

                        mAdapter = new RecyclerAdapter(Goa.this,products);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                progressBar.setVisibility(View.GONE);
                Toast.makeText(Goa.this, error.toString(),Toast.LENGTH_LONG).show();

            }
        });
        Volley.newRequestQueue(Goa.this).add(stringRequest);
